            ...
            <div class="flex items-start">
              <div class="flex-shrink-0">
                <CheckCircleIcon
                  ...
                  aria-hidden="true"
                  v-if="notificationStore.notification.isSuccess"
                />
...
let lastDismissTimeout: number | undefined;

// automatically dismiss notifications
watch(
  () => notificationStore.notification.timestamp,
  () => {
    show.value = true;
    clearTimeout(lastDismissTimeout);
    lastDismissTimeout = setTimeout(() => {
      show.value = false;
    }, 5000);
  }
);
